...
declare function $$render<NodeType extends Node = Node, EdgeType extends Edge = Edge>(): {
    props: import("../../types").NodeEvents<NodeType> & import("../../types").NodeSelectionEvents<NodeType> & import("../../types").EdgeEvents<EdgeType> & import("../../types").PaneEvents & {
        ...
        onreconnectend?: import("@xyflow/system").OnReconnectEnd<NodeType, EdgeType> | undefined;
...
declare class __sveltets_Render<NodeType extends Node = Node, EdgeType extends Edge = Edge> {
    props(): ReturnType<typeof $$render<NodeType, EdgeType>>['props'];
    events(): ReturnType<typeof $$render<NodeType, EdgeType>>['events'];
    slots(): ReturnType<typeof $$render<NodeType, EdgeType>>['slots'];
    bindings(): "nodes" | "edges" | "viewport";
    exports(): {};
}
